// Importa o decorator Injectable do NestJS, que permite que essaclasse seja injetada como dependência em outros lugares(como ocontroller)
import { Injectable } from '@nestjs/common';
// Importa o PrismaClient, que é o cliente gerado pelo Prismaara interagir com o banco de dados
